...
A few unit tests were done to demonstrate the use of the expression classes within the `smpl.sys` namespace. The functions can be accessed by importing the _smpl-coore-outar-x.x.x.jar_ file generated by the build of this project and deposited in the [lib](/lib) folder.
