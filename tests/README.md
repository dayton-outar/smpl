...
| <h5>Multiply a number times 5</h5><blockquote>`number`:<br />3.1<br />11.2<br />13.5</blockquote><ol>Create a `DoubleExpression` object with constructor value of `number`</li><li>Create `DoubleExpression` with constructor value of 5</li><li>Inject both `DoubleExpression` objects into `MutiplicationExpression`</li><li>Evaluate the expression object in last step above</li></ol> | 15.5<br />56<br />67.5 | 15.5<br />56<br />67.5 |
